...
using PokemonGo.RocketBot.WPF.Models;
        ...
        public void Write(string message, LogLevel level = LogLevel.Info, ConsoleColor color = ConsoleColor.Black)
        {
            ...
            switch (level)
            {
                ...
                case LogLevel.LevelUp:
                    ...
                    break;
                case LogLevel.Berry:
                    MainWindow.ColoredConsoleWrite(Color.DarkGoldenrod,
                ...
                case LogLevel.Egg:
                    ...
                    break;
                case LogLevel.Debug:
                    MainWindow.ColoredConsoleWrite(Color.Gray,
