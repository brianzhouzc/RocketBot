...
namespace NecroBot2.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.AmountPkmSeenCaught, "Amount of Pokemon Seen: {0}/151, Amount of Pokemon Caught: {1}/151"),
            new KeyValuePair<TranslationString, string>(TranslationString.PkmPotentialEvolveCount, "Potential Evolutions: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.PkmNotEnoughRessources, "Pokemon Upgrade Failed Not Enough Resources"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupTelegramPrompt, "Would you like to enable the Telegram Feature? {0}/{1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupTelegramCodePrompt, "Please enter your Telegram API Key (Right click to paste)"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupTelegramCodeConfirm, "Accepted Telegram API Key: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupTelegramPasswordPrompt, "Please enter your Telegram Password (DEFAULT: 12345)"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupTelegramPasswordConfirm, "Accepted Telegram Password: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyPrompt, "Would you like to enable the Proxy Feature? {0}/{1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyHostPrompt, "Please enter your Proxy Host"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyHostConfirm, "Accepted Proxy Host: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyPortPrompt, "Please enter your Proxy Port"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyPortConfirm, "Accepted Proxy Port: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyAuthPrompt, "Would you like to enable the Proxy Authentication? {0}/{1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupProxyUsernamePrompt, "Please enter your Proxy Username (Right click to paste)"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupWalkingSpeedKmHConfirm, "Accepted Walking Speed: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FirstStartSetupUseWalkingSpeedVariantPrompt, "Would you like to enable the Walking Speed Variant Setting? {0}/{1}"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.SoftBanBypassed, "Successfully bypassed!"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.CatchLimitReached, "You have reached your set maximum number of Pokemon catched per 24 Hours. Catching disabled until bot is restarted and PokemonTS.txt + PokestopTS.txt are deleted."),
            new KeyValuePair<TranslationString, string>(TranslationString.CatchTimerReached, "You have reached your set maximum running time for Catching Pokemon per 24 Hours. Catching disabled until bot is restarted and PokemonTS.txt + PokestopTS.txt are deleted."),
            new KeyValuePair<TranslationString, string>(TranslationString.PokestopLimitReached, "You have reached your set maximum number of Pokestops per 24 Hours. Looting of Pokestops disabled until bot is restarted and PokemonTS.txt + PokestopTS.txt are deleted."),
            new KeyValuePair<TranslationString, string>(TranslationString.PokestopTimerReached, "You have reached your set maximum running time to loot Pokestops per 24 Hours. Looting of Pokestops disabled until bot is restarted and PokemonTS.txt + PokestopTS.txt are deleted."),
            new KeyValuePair<TranslationString, string>(TranslationString.ExitDueToLimitsReached, "We have reached both the user defined max Pokestops/max duration and caught max Pokemons/max duration. Time to take a break. Exiting."),
