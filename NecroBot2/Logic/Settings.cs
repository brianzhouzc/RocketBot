...
namespace NecroBot2.Logic
{
    ...
    public class ClientSettings : ISettings
    {
        ...
        {
            get { return _settings.Auth.UsePogoDevAPI; }
            set { _settings.Auth.UsePogoDevAPI = value; }
       }

        public bool UseLegacyAPI
        {
            get { return _settings.Auth.UseLegacyAPI; }
            set { _settings.Auth.UseLegacyAPI = value; }
        }

        public string AuthAPIKey
        {
            get { return _settings.Auth.AuthAPIKey; }
            set { _settings.Auth.AuthAPIKey = value; }
        }
    ...
    public class LogicSettings : ILogicSettings
    {
        ...
        public bool UsePogoDevAPI => _settings.Auth.UsePogoDevAPI;
        public string AuthAPIKey => _settings.Auth.AuthAPIKey;
        public bool UseLegacyAPI => _settings.Auth.UseLegacyAPI;
