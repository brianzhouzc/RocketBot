...
namespace NecroBot2.Logic.State
{
    public class VersionCheckState : IState
    {
        public const string VersionUri =
            "https://raw.githubusercontent.com/Furtif/NecroBot/Graphical_Interfaces/PoGo.NecroBot.Logic/Properties/AssemblyInfo.cs";
        ...
        public async Task<IState> Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            var remoteReleaseUrl =
                $"https://github.com/Furtif/NecroBot/releases/download/v{RemoteVersion}/";
