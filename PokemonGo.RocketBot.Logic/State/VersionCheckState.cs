...
{ 
        ...
        public const string LatestReleaseApi =
            "https://api.github.com/repos/TheUnnameOrganization/RocketBot/releases/latest";
        ...
        public async Task<IState> Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            var remoteReleaseUrl =
                $"https://github.com/TheUnnameOrganization/RocketBot/releases/download/{RemoteVersion}/";
            ...
            var extractedDir = Path.Combine(tempPath, "");
