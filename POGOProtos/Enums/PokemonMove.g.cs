...
namespace POGOProtos.Enums {
    ...
    static PokemonMoveReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "D1JPQ0tfU01BU0hfRkFTVBDxARITCg5UUkFOU0ZPUk1fRkFTVBDyARIRCgxD",
            "T1VOVEVSX0ZBU1QQ8wESFQoQUE9XREVSX1NOT1dfRkFTVBD0ARIRCgxDTE9T",
            "RV9DT01CQVQQ9QESEgoNRFlOQU1JQ19QVU5DSBD2ARIQCgtGT0NVU19CTEFT",
            "VBD3ARIQCgtBVVJPUkFfQkVBTRD4ARIVChBDSEFSR0VfQkVBTV9GQVNUEPkB",
            "EhUKEFZPTFRfU1dJVENIX0ZBU1QQ+gESEAoLV0lMRF9DSEFSR0UQ+wESDwoK",
            "WkFQX0NBTk5PThD8ARIVChBEUkFHT05fVEFJTF9GQVNUEP0BEg4KCUFWQUxB",
            "TkNIRRD+ARITCg5BSVJfU0xBU0hfRkFTVBD/ARIPCgpCUkFWRV9CSVJEEIAC",
            "Eg8KClNLWV9BVFRBQ0sQgQISDgoJU0FORF9UT01CEIICEg8KClJPQ0tfQkxB",
            "U1QQgwISFQoQSU5GRVNUQVRJT05fRkFTVBCEAhIWChFTVFJVR0dMRV9CVUdf",
            "RkFTVBCFAhIQCgtTSUxWRVJfV0lORBCGAhISCg1BU1RPTklTSF9GQVNUEIcC",
            "Eg0KCEhFWF9GQVNUEIgCEhAKC05JR0hUX1NIQURFEIkCEhMKDklST05fVEFJ",
            "TF9GQVNUEIoCEg4KCUdZUk9fQkFMTBCLAhIPCgpIRUFWWV9TTEFNEIwCEhMK",
            "DkZJUkVfU1BJTl9GQVNUEI0CEg0KCE9WRVJIRUFUEI4CEhUKEEJVTExFVF9T",
  ...
  public enum PokemonMove {
    ...
    [pbr::OriginalName("TRANSFORM_FAST")] TransformFast = 242,
    [pbr::OriginalName("COUNTER_FAST")] CounterFast = 243,
    [pbr::OriginalName("POWDER_SNOW_FAST")] PowderSnowFast = 244,
    [pbr::OriginalName("CLOSE_COMBAT")] CloseCombat = 245,
    [pbr::OriginalName("DYNAMIC_PUNCH")] DynamicPunch = 246,
    [pbr::OriginalName("FOCUS_BLAST")] FocusBlast = 247,
    [pbr::OriginalName("AURORA_BEAM")] AuroraBeam = 248,
    [pbr::OriginalName("CHARGE_BEAM_FAST")] ChargeBeamFast = 249,
    [pbr::OriginalName("VOLT_SWITCH_FAST")] VoltSwitchFast = 250,
    [pbr::OriginalName("WILD_CHARGE")] WildCharge = 251,
    [pbr::OriginalName("ZAP_CANNON")] ZapCannon = 252,
    [pbr::OriginalName("DRAGON_TAIL_FAST")] DragonTailFast = 253,
    [pbr::OriginalName("AVALANCHE")] Avalanche = 254,
    [pbr::OriginalName("AIR_SLASH_FAST")] AirSlashFast = 255,
    [pbr::OriginalName("BRAVE_BIRD")] BraveBird = 256,
    [pbr::OriginalName("SKY_ATTACK")] SkyAttack = 257,
    [pbr::OriginalName("SAND_TOMB")] SandTomb = 258,
    [pbr::OriginalName("ROCK_BLAST")] RockBlast = 259,
    [pbr::OriginalName("INFESTATION_FAST")] InfestationFast = 260,
    [pbr::OriginalName("STRUGGLE_BUG_FAST")] StruggleBugFast = 261,
    [pbr::OriginalName("SILVER_WIND")] SilverWind = 262,
    [pbr::OriginalName("ASTONISH_FAST")] AstonishFast = 263,
    [pbr::OriginalName("HEX_FAST")] HexFast = 264,
    [pbr::OriginalName("NIGHT_SHADE")] NightShade = 265,
    [pbr::OriginalName("IRON_TAIL_FAST")] IronTailFast = 266,
    [pbr::OriginalName("GYRO_BALL")] GyroBall = 267,
    [pbr::OriginalName("HEAVY_SLAM")] HeavySlam = 268,
    [pbr::OriginalName("FIRE_SPIN_FAST")] FireSpinFast = 269,
    [pbr::OriginalName("OVERHEAT")] Overheat = 270,
    [pbr::OriginalName("BULLET_SEED_FAST")] BulletSeedFast = 271,
    [pbr::OriginalName("GRASS_KNOT")] GrassKnot = 272,
    [pbr::OriginalName("ENERGY_BALL")] EnergyBall = 273,
    [pbr::OriginalName("EXTRASENSORY_FAST")] ExtrasensoryFast = 274,
    [pbr::OriginalName("FUTURESIGHT")] Futuresight = 275,
    [pbr::OriginalName("MIRROR_COAT")] MirrorCoat = 276,
    [pbr::OriginalName("OUTRAGE")] Outrage = 277,
